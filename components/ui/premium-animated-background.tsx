...
import { holographicThemes } from '@/lib/holographic-design-system'
...
export function PremiumAnimatedBackground() {
  ...
  const getThemeColors = () => {
    ...
    return themeMap[currentTheme as keyof typeof themeMap] || themeMap['aurora-daybreak']
  }
  ...
  }, [dimensions, currentTheme, resolvedTheme])
