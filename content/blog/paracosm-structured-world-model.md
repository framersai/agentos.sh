...
**Not classical agent-based modeling.** Mesa, NetLogo, MASON, AnyLogic, ABIDES: longstanding ABM tooling, generally rule-based or statistical, generally non-LLM. The [Nature HSSC 2024 survey on LLM-empowered ABM](https://www.nature.com/articles/s41599-024-03611-3) and [MIT Media Lab's "On the limits of agency in agent-based models"](https://arxiv.org/abs/2409.10568) are the bridge literature for hybrid approaches. Read them for the theoretical backdrop.
